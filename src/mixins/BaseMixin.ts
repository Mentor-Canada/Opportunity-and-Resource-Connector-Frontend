...
export default {
  ...
  data() {
    ...
    let currentLanguage = globals.app.language.langcode
    let sortedLanguages = globals.app.languages.list
  ...
  methods: {
    ...
    languageToggle(language: string): string {
      let components = globals.router.currentRoute.fullPath.split('/')
