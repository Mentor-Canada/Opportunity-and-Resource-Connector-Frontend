export default {
  ...
  methods: {
    ...
    formatInputDate(date) {
      ...
      const d = this.getDateFromFormat(date);
    ...
    getDateFromFormat(date) {
      ...
      const year = format.indexOf('yyyy');
      const month = format.indexOf('mm');
    ...
    formatInputDateRange(dateRange) {
      ...
      const startDate = start ? this.getDateFromFormat(start) : null;
      const endDate = end ? this.getDateFromFormat(end) : null;
